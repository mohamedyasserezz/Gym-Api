...
namespace Gym_Api.Migrations
{
    ...
    [Migration("20250501150608_Add Seeding data for userRole table")]
    partial class AddSeedingdataforuserRoletable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gym_Api.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEO8krX6B0YDB8owIsv8aq7JJB3Le+kx94IGgCUyh5v+Nmt++f3HfQIVG2wbMvF+nFw==",
